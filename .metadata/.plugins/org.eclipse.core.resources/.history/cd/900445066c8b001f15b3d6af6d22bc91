...
public class Menu1 extends JFrame implements ActionListener {
    ...
    public Menu1() {
        ...
        jMenuBar.setFont(new Font("Segoe UI", Font.BOLD, 15));
...
//        PanelNhaHangMenu1 panelNhaHangMenu1 = new PanelNhaHangMenu1();
//        contentPanel.add(panelNhaHangMenu1, "MenuNhaHang1"); // trong chuỗi là từ khoá để gọi trùng khớp hàm action ở dưới
//        
//        menu = new JMenu("New menu");
//        panelNhaHangMenu1.add(menu);
