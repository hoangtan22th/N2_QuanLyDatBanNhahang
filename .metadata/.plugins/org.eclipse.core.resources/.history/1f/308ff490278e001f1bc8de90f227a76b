 ...
 * @author Admin
 */
public class CocTien extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CocTien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
