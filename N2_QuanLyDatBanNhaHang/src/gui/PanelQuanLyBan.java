...
//    	JOptionPane.showMessageDialog(null, ban.getTenBan());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnThem) {
			...
			JOptionPane.showMessageDialog(null, "Cập nhật bàn thành công!", "Thông báo",
					JOptionPane.INFORMATION_MESSAGE);
			loadBanButtons();
		} else if (e.getSource() == btnXoa) {

			String maBan = lblMa.getText();
			int confirm = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa bàn này?", "Xác nhận",
					JOptionPane.YES_NO_OPTION);
			if (confirm == JOptionPane.YES_OPTION) {
				BanDAO banDAO = new BanDAO();
				banDAO.deleteBan(maBan);
				JOptionPane.showMessageDialog(null, "Xóa bàn thành công!", "Thông báo",
						JOptionPane.INFORMATION_MESSAGE);
				loadBanButtons();
			}
